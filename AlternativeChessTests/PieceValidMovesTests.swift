...
final class PieceValidMovesTests: XCTestCase {
    ...
    func testCheckMate() {
        ...
        let pieces = [Piece(type: .king, colour: .white, position: Position(file: .E, rank: .first)),
                      Piece(type: .queen, colour: .black, position: Position(file: .C, rank: .fourth)),
                      Piece(type: .bishop, colour: .black, position: Position(file: .G, rank: .fourth)),
                      Piece(type: .king, colour: .black, position: Position(file: .E, rank: .eighth))]
        let chessEngine = createSUT(pieces: pieces, turn: .white)
    ...
    func testKingsTouchEachOther() {
        ...
        let pieces = [Piece(type: .king, colour: .white, position: Position(file: .C, rank: .eighth)),
                      Piece(type: .king, colour: .black, position: Position(file: .E, rank: .eighth))]
        let chessEngine = createSUT(pieces: pieces, turn: .white)
